...
<!--   <h1>Select Provider</h1>
    ...
    <h4>Cégként vagy egyéni felhasználóként kíván regisztrálni?</h4>
    <input type="radio" name="is_company" value="Yes" id="company">
    <label for="company">Cégként</label><br>
    <input type="radio" name="is_company" value="No" id="not_company">
    <label for="not_company">Egyéni felhasználóként</label><br>
