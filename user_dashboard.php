...
<div class="container mt-5">
    ...
    <a href="edit_profile.php" class="btn btn-primary">Profil szerkesztése</a>
    <a href="change_password.php" class="btn btn-warning">Jelszó megváltoztatása</a>
    <a href="logout.php" class="btn btn-danger">Kijelentkezés</a>
    <a href="job_listings.php" class="btn btn-primary">Állásajánlatok megtekintése</a>
